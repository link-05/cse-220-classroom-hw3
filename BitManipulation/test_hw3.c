...
// Test(SwapOddEvenBits, testCases) {
// 	//Test Cases explanation and type is in README.MD
...
// Test cases, explanation and classification of edge case is in README.MD
...
// Test(ReprConvert, testCases) {
// 	// My test cases,the explanation and type is in README.MD
// 	// Max negative in 2's complement
// 	repr_convert('2', 'S', 0x80000001);

// 	repr_convert('S', '2', 0x80000005);

// 	// Cases of all 0, negative and positive 0.
